...
def listar_ambientes():
    ...
    return render_template('ambiente/list.html', ambientes=ambientes)
...
def ver_ambiente(ambiente_id):
    ...
    return render_template('ambiente/detail.html', ambiente=ambiente)
...
def ambiente_inventario(ambiente_id):
    ambiente = Ambiente.query.get_or_404(ambiente_id)
    return render_template('inventario/ambiente.html', ambiente=ambiente)
...
def crear_ambiente():
    if request.method == 'GET':
        return render_template('ambiente/form.html', accion='crear')
...
def editar_ambiente(ambiente_id):
    ...
    if request.method == 'GET':
        return render_template('ambiente/form.html', ambiente=ambiente, accion='editar')
